        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-sm mt-4" style={{ color: '#0A2540', opacity: 0.7 }}>
              ...
              <Link href="/signup" className="font-semibold transition-colors" style={{ color: '#1C7C63' }} onMouseEnter={(e) => e.currentTarget.style.color = '#155a47'} onMouseLeave={(e) => e.currentTarget.style.color = '#1C7C63'}>
                Create one
              </Link>
            </p>
          </div>
